...
namespace AudioServer.Web.Services
{
    ...
    public class SherpaEngineService : IVoiceEngineService
    {
        ...
        public SherpaEngineService(IOptions<VoskServerOption> voskOptions,ILogService logService)
        {
        ...
        public async Task<string> RecognizeSpeechAsync(int maxDurationSeconds,float deep)
        {
            // 1. 检查模型
